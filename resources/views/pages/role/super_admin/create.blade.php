<x-app-layout>
        ...
        <div class="max-w-7xl lg:max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form id="super-admin-form" action="{{ route('super-admin.store') }}" method="POST" novalidate>
                        @csrf
                        <div class="mb-6">
                            <label for="name"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="email" name="email" id="email" {{-- Menambahkan atribut name --}}
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required />
                        </div>
                        <div class="mb-6">
                            ...
                            <input type="password" name="password" id="password" {{-- Menambahkan atribut name --}}
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required />
                        </div>
                        <div class="mb-6">
    ...
    <script>
        document.getElementById('super-admin-form').addEventListener('submit', function(event) {
            ...
            if (name === '' && email === '' && password === '' && passwordConfirmation === '') {
                ...
                Swal.fire({
                    title: 'Uploading...',
                    text: 'Tunggu sebentar, sedang mengunggah data super admin.',
                    icon: 'info',
                    allowOutsideClick: false,
                ...
                fetch(form.action, {
                    ...
                    if (response.ok) {
                        Swal.fire({
                            title: 'Super Admin Berhasil Ditambah.',
                            icon: 'success',
                            ...
                            window.location.href = "{{ route('super-admin.index') }}"; // Sesuaikan dengan URL yang diinginkan
                        });
                    } else {
                        Swal.fire({
                            title: 'Error!',
