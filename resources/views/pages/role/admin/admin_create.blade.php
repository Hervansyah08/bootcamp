        ...
        <div class="max-w-7xl lg:max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form id="admin-form" action="{{ route('admin.store') }}" method="POST" novalidate>
                        @csrf
                        <div class="mb-6">
                            <label for="name"
    ...
    <script>
        document.getElementById('admin-form').addEventListener('submit', function(event) {
            ...
            if (name === '' && email === '' && password === '' && passwordConfirmation === '') {
                ...
                Swal.fire({
                    title: 'Uploading...',
                    text: 'Tunggu sebentar, sedang mengunggah data admin.',
                    icon: 'info',
                    allowOutsideClick: false,
                ...
                fetch(form.action, {
                    ...
                    if (response.ok) {
                        Swal.fire({
                            ...
                            window.location.href = "{{ route('admin.index') }}"; // Sesuaikan dengan URL yang diinginkan
                        });
                    } else {
                        Swal.fire({
                            title: 'Error!',
