        ...
        <div class="max-w-7xl lg:max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form id="edit-form" action="{{ route('admin.update', $user->id) }}" method="POST" novalidate>
                        @csrf
                        @method('PUT')
                        <div class="mb-6">
                            <label for="name"
            ...
            if (name === '' && email === '') {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            title: 'Uploading...',
                            text: 'Tunggu sebentar, sedang mengunggah perubahan admin.',
                            icon: 'info',
                            allowOutsideClick: false,
                        ...
                        fetch(form.action, {
                            ...
                            if (response.ok) {
                                Swal.fire({
                                    title: 'Admin Berhasil Diperbarui',
                                    icon: 'success',
